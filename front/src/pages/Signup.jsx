            ...
            <div className="col-md-6 mt-3 offset-md-3">
                ...
                <div className="card my-5 border border-dark">
                    <div className="card-header bg-dark-blue">
                        <h4 className=''>USER REGISTRATION</h4>
                        <small className='text-dark'>If you already a member, <NavLink className="text-orange" to="/login">click here</NavLink></small>
                    </div>
                    ...
                    <div className="card-footer bg-dark-blue">
                        <button type='submit' className='btn btn-light bg-info'>Registration</button>
                    </div>
                </div>
                </form>
            </div>

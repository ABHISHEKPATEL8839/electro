...
const Login = () => {
    ...
    let LoginFrm = useFormik({
        ...
        onSubmit : (formData)=>{
            ...
            axios
            .post(`${import.meta.env.VITE_API_URL}/auth`, formData)
            .then(response=>{
            ...
            <div className="col-md-6 mt-3 offset-md-3">
                <div className="card mt-5 border border-dark">
                    <div className="card-header bg-dark-blue">
                        ...
                        <small className='text-dark'>IF YOU A NEW USER, <NavLink to="/signup" className="text-sucess">click here</NavLink></small>
                    </div>
                    ...
                    <div className="card-footer bg-dark-blue">
                        <button type='submit' className='btn btn-light bg-info'>Login</button>
                        <br />
                        <br />
                    <NavLink className='text-dark bg-success btn' to='/forgot-password'>Forgot Your Password</NavLink>
                    </div>
                </div>
            </div>
        </div>

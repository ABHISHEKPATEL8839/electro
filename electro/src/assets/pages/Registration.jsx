                ...
                <div class="row g-4">
                    <div class="col-12">
                        <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style={{maxWidth: "900px"}}>
                            <h4 class="text-primary border-bottom border-primary border-2 d-inline-block pb-2">REGISTRATION</h4><br/>
                            <a class="mb-5 fs-5 text-dark" href='/login'>ALL READY HAVE ACCOUNT 
                            </a>
                        </div>
                    </div>
                        ...
                        <form>
                            <div class="row g-4 wow fadeInUp" data-wow-delay="0.1s">
                                ...
                                <div class="col-lg-12 col-xl-6">
                                  ...
                                  <div class="col-12">
                                    <div class="form-floating">
                                       <select style={{width:"100%",height:"50px",border:"10px"}}>
